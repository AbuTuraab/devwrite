...
type OpRenameConstraint = z.infer<typeof OpRenameConstraintDefinition>;
declare const OpRenameConstraintDefinition: z.ZodObject<{
    from: z.ZodString;
    to: z.ZodString;
    table: z.ZodString;
}, "strip", z.ZodTypeAny, {
...
declare const operationTypes: readonly ["add_column", "alter_column", "create_index", "create_table", "drop_column", "drop_constraint", "rename_constraint", "drop_index", "drop_table", "sql", "rename_table", "set_replica_identity"];
    ...
    readonly $defs: {
        ...
        readonly ForeignKeyReference: {
            ...
            readonly properties: {
                ...
                readonly on_delete: {
                    readonly description: "On delete behavior of the foreign key constraint";
                    readonly type: "string";
                    readonly enum: readonly ["NO ACTION", "RESTRICT", "CASCADE", "SET NULL", "SET DEFAULT"];
                    readonly default: "NO ACTION";
                };
            };
        ...
        readonly OpAlterColumn: {
            ...
            readonly properties: {
                ...
                readonly default: {
                    readonly description: "Default value of the column";
                    readonly type: "string";
                };
                readonly nullable: {
                ...
                readonly comment: {
                    readonly description: "New comment on the column";
                    readonly type: readonly ["string", "null"];
                    readonly goJSONSchema: {
                        readonly imports: readonly ["github.com/oapi-codegen/nullable"];
                        readonly nillable: true;
                        readonly type: "nullable.Nullable[string]";
                    };
                };
                readonly up: {
                    readonly default: "";
        ...
        readonly OpRenameConstraint: {
            readonly additionalProperties: false;
            readonly description: "Rename constraint operation";
            readonly properties: {
                readonly from: {
                    readonly description: "Name of the constraint";
                    readonly type: "string";
                ...
                readonly to: {
                    readonly description: "New name of the constraint";
                    readonly type: "string";
                };
                readonly table: {
                    readonly description: "Name of the table";
            ...
            readonly required: readonly ["from", "to", "table"];
            readonly type: "object";
        };
        ...
        readonly PgRollOperation: {
            readonly anyOf: readonly [{
                ...
                readonly additionalProperties: false;
                readonly properties: {
                    readonly rename_constraint: {
                        readonly $ref: "#/$defs/OpRenameConstraint";
                    };
                };
                readonly required: readonly ["rename_constraint"];
            }, {
                readonly type: "object";
                readonly description: "Drop index operation";
                readonly additionalProperties: false;
